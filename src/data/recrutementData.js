...
export const offres = {
  ...
  specialites: [
    ...
    { id: "gynecologie-sage-femme", label: "Gynécologie & Sage-femme" },
    { id: "radiologie",             label: "Radiologie / Mammographie" },
    { id: "soins-infirmiers",       label: "Soins infirmiers" },
    { id: "tech",                   label: "Tech & support" },
  ...
  regions: [
    ...
    { id: "national",                label: "Itinérant (national)" },
    ...
    items: [
      {
        ...
        nouveau: true,
        date: "15/04/26",
        specialiteId: "gynecologie-sage-femme",
        regions: ["national"],
      },
      {
        id: "o2",
      ...
      },
      {
        ...
        nouveau: false,
        date: "20/02/26",
        specialiteId: "medecine-generale",
        regions: ["national"],
      },
    ],
  },
  internes: {
    ...
    items: [
      ...
      },
      {
        ...
        statut: "a-venir",
        date: null,
        specialiteId: "operations",
        regions: ["grand-est", "national"],
      },
    ],
  },
};
