...
const avis = [
  ...
  },
  {
    ...
    quote: "L'organisation est remarquable : prise de rendez-vous, déroulement, tous les créneaux remplis rapidement. Ce concept permet un examen complet dans un cadre rassurant.",
