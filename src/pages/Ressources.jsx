...
import { ressourcesFiltres, ressourcesCards } from "../data/arborescence";
...
export default function Ressources() {
  ...
  const cartesFiltrees =
    actif === ressourcesFiltres[0]
      ? ressourcesCards
      : ressourcesCards.filter((c) => c.audience === actif);

  return (
    <div className="max-w-7xl mx-auto px-6 py-16">

      {/* En-tête */}
      <h1 className="font-display font-bold text-4xl text-gray-900 mb-10">
        Ressources
      </h1>
