      ...
      >
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6">
          ...
          <div className="space-y-3">
            ...
            <input
              disabled
              placeholder={hero.form.communePlaceholder}
              className="w-full bg-gray-50 border border-gray-200 text-gray-400 placeholder-gray-400 rounded-lg px-3 py-2.5 text-sm cursor-not-allowed"
            />
            <select
              disabled
        ...
        <div className="bg-gray-100 border border-gray-200 rounded-xl p-5">
          <p className="font-semibold text-gray-900 text-sm mb-2">
            {hero.patientCard.titre}
          </p>
          <p className="text-gray-600 text-xs leading-relaxed mb-4">
            {hero.patientCard.texte}
          </p>
          <button
            type="button"
            className="w-full border border-gray-300 text-gray-700 text-sm font-semibold py-2.5 rounded-full hover:bg-gray-200 transition-colors cursor-pointer"
          >
